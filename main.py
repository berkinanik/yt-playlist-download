...
def main():
    ...
    # downloadPath = "C:\\Users\\Berkin\\Desktop\\YoutubeDownloads\\example-folder\\"
    ...
    for vidLink in videos:
        ...
        fileName = (
            ...
            + result.title.lower()
            .replace("middle east technical university", "") #remove words you want as lower case from name 
            .replace("removethisonealso", "") 
            .replace("2022", "") #numbers also
            .replace("metu", "odtu") #or replace
            + ".mp4"
        )
        invalidChars = '<>:;_.,"/\|?* '
